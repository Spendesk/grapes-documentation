...
| feat(pencil): add 'graphiteWidth                                                                            | Feature Release  |
| perf(pencil): remove graphiteWidth option <br /> BREAKING CHANGE: The graphiteWidth option has been removed | Breaking Release |
