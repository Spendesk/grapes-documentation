...
The `getIsOptionDisabled` allows you to disable options in the ListBox. These options will be neither clickable nor selectable.
...
Adheres to the [`listbox` role requirements](https://www.w3.org/TR/wai-aria-1.2/#listbox).
