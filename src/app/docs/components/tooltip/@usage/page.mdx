...
Use the `placement` prop to specifies where the tooltip should be positioned.
...
```tsx
<Tooltip content="This is some useful information in a tooltip" placement="top">
  <Button variant="primary" isDisabled text="Top tooltip" />
</Tooltip>
<Tooltip
  content="This is some useful information in a tooltip"
...
If the `isOpen` prop is set to `true`, the tooltip will appear.
