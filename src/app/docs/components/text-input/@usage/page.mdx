...
<Preview>
  <TextInput variant="magicGradient" className="w-[360px]" placeholder="Enter account number" />
</Preview>
...
<Preview>
  <TextInput className="w-[360px]" placeholder="Enter account number" leftAddon={<Icon color="var(--color-primary)" name="robot" className="ml-xs" />} />
  <TextInput className="w-[360px]" placeholder="Enter account number" rightAddon={<Button variant="ghost" text="OK" />} />
</Preview>

```tsx
<>
  <TextInput leftAddon={<Icon color="var(--color-primary)" name="robot" className="ml-xs" />} {...otherProps} />
  <TextInput rightAddon={<Button variant="ghost" text="OK" />} {...otherProps} />
</>
```
