  ...
  return (
    <div style={ogRoot}>
      <div style={ogContainer}>
        <div style={ogColorContainer}>
          <div style={ogColorBlock1}></div>
          <div style={ogColorBlock2}></div>
          <div style={ogColorBlock3}></div>
          <div style={ogColorBlock4}></div>
          <div style={ogColorBlock5}></div>
          <div style={ogColorBlock6}></div>
          <div style={ogColorBlock7}></div>
          <div style={ogColorBlock8}></div>
        </div>

        <div style={ogLogoContainer}>
          <svg
